...
{\LARGE\bf Ejercicios del Apéndice D}\\[4pt]
{\large Subdiferencial de funciones convexas}
\end{center}
\bigskip
\noindent{\small Los ejercicios son los de la sección de ejercicios del Apéndice~D de las notas del curso, con la misma numeración. Las referencias a teoremas, proposiciones y secciones remiten a las notas (\url{https://github.com/jfbonder/transporte-optimo}).}
\medskip
