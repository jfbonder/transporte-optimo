...
{\LARGE\bf Práctica 9}\\[4pt]
{\large El teorema de factorización polar de Brenier}
\end{center}
\bigskip
\noindent{\small Los ejercicios son los de la sección de ejercicios del Capítulo~9 de las notas del curso, con la misma numeración. Las referencias a teoremas, proposiciones y secciones remiten a las notas (\url{https://github.com/jfbonder/transporte-optimo}).}
\medskip
