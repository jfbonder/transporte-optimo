...
{\LARGE\bf Ejercicios del Apéndice C}\\[4pt]
{\large Factorización polar de matrices inversibles}
\end{center}
\bigskip
\noindent{\small Los ejercicios son los de la sección de ejercicios del Apéndice~C de las notas del curso, con la misma numeración. Las referencias a teoremas, proposiciones y secciones remiten a las notas (\url{https://github.com/jfbonder/transporte-optimo}).}
\medskip
