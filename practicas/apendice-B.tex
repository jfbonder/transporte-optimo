...
\encabezado{Apéndice B: El teorema de Fenchel--Rockafellar}
\bigskip
\pagestyle{fancy}
\fancyhead[L]{{\footnotesize{\usefont{T1}{phv}{m}{n}{\sc Teoría de Transporte Óptimo}}}}
\fancyhead[R]{\footnotesize \usefont{T1}{phv}{m}{n}{\sc Apéndice B}}
\thispagestyle{plain}
\noindent{\footnotesize Los ejercicios son los de la sección de ejercicios del Apéndice~B de las notas del curso, con la misma numeración; las referencias a teoremas, proposiciones y secciones remiten a las notas (\url{https://github.com/jfbonder/transporte-optimo}).}
\medskip
