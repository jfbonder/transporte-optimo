...
\ejlabel{A.4}{Desintegración y transporte condicional}(a) Para $\phi(x,y)$,
\[
\int\phi\circ T\,d\mu
=\int\Bigl(\int\phi(T^1(x),T^2_x(y))\,d\mu_x(y)\Bigr)d\mu^1(x)
=\int\Bigl(\int\phi(T^1(x),z)\,d\nu_{T^1(x)}(z)\Bigr)d\mu^1(x),
\]
